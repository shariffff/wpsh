...
var configCmd = &cobra.Command{
	Use:   "config",
	Short: "Manage wpsh configuration",
	Long:  `Display, validate, and edit the wpsh configuration file.`,
}
...
var configShowCmd = &cobra.Command{
	...
	Long:  `Display the contents of the wpsh configuration file.`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		if !mgr.ConfigExists() {
			...
			fmt.Println("Run 'wpsh init' to create it.")
			os.Exit(1)
		}
...
var configValidateCmd = &cobra.Command{
	...
	Long:  `Validate the wpsh configuration file for correctness and consistency.`,
	Run: func(cmd *cobra.Command, args []string) {
		mgr, err := config.NewManager()
		if err != nil {
			color.Red("Error: %v", err)
...
var configEditCmd = &cobra.Command{
	...
	Long:  `Open the wpsh configuration file in your preferred editor. On first run, you'll be prompted to select an editor.`,
	Run: func(cmd *cobra.Command, args []string) {
		mgr, err := config.NewManager()
		if err != nil {
			color.Red("Error: %v", err)
